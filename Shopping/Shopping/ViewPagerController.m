...
#define kDefaultTabHeight 32.0 // Default tab height
#define kDefaultTabOffset 20.0 // Offset of the second and further tabs' from left
...
- (void)reloadData {
    ...
    _tabsView.bounces = YES;
    _tabsView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"category_tabbar_background.png"]];
    _tabsView.alwaysBounceHorizontal = YES;
